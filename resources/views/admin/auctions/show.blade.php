        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.auctions.index') }}">Manage Auctions</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View Details</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('admin.auctions.index') }}" class="btn-premium-back text-decoration-none">
            <i class="fas fa-arrow-left mr-2"></i> Back to List
        </a>
    </div>
            @if($auction->trashed())
                <form action="{{ route('admin.auctions.restore', $auction->id) }}" method="POST" class="d-inline">
                    @csrf
