...
<div class="card card-elite border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
    <div class="card-body p-0">
        <div class="table-responsive p-4">
            <table class="table table-hover align-middle mb-0 w-100" id="watchlistTable" style="border-collapse: separate; border-spacing: 0 12px;">
                <thead>
...
$(document).ready(function() {
    var table = $('#watchlistTable').DataTable({
        ...
        columns: [
            ...
            { data: 'category', name: 'auction.category.name' },
            { data: 'price', name: 'auction.current_price' },
            { data: 'end_time', name: 'auction.end_time' },
